...
html, body, [class*="css"] { font-family: 'DM Mono', monospace; background-color: #080b10; color: #c9d1d9; }
...
.app-title{font-family:'Cormorant Garamond',serif;font-size:3rem;font-weight:300;letter-spacing:.06em;color:#e8dcc8;margin-bottom:.1rem;line-height:1;}
.app-sub{font-size:.68rem;letter-spacing:.25em;text-transform:uppercase;color:#5a6478;margin-bottom:2.5rem;}
.section-label{font-size:.6rem;letter-spacing:.28em;text-transform:uppercase;color:#5a6478;border-bottom:1px solid #1a2235;padding-bottom:.5rem;margin:2rem 0 1.2rem 0;}

/* Metric cards */
div[data-testid="metric-container"]{background:linear-gradient(135deg,#0f1420,#0c1118);border:1px solid #1a2235;border-radius:2px;padding:1.4rem 1.6rem;position:relative;overflow:hidden;}
...
div[data-testid="metric-container"] label{font-size:.6rem!important;letter-spacing:.2em;text-transform:uppercase;color:#5a6478!important;}
div[data-testid="metric-container"] [data-testid="stMetricValue"]{font-family:'Cormorant Garamond',serif;font-size:2.4rem!important;font-weight:300!important;color:#e8dcc8!important;letter-spacing:.02em;}
...
.sidebar-title{font-family:'Cormorant Garamond',serif;font-size:1.5rem;font-weight:300;color:#e8dcc8;letter-spacing:.08em;margin-bottom:.2rem;}
.sidebar-sub{font-size:.6rem;letter-spacing:.22em;text-transform:uppercase;color:#5a6478;margin-bottom:2rem;}

/* Inputs */
[data-testid="stNumberInput"] input,[data-testid="stDateInput"] input{background:#0c1118!important;border:1px solid #1a2235!important;border-radius:2px!important;color:#c9d1d9!important;font-family:'DM Mono',monospace!important;font-size:.85rem!important;}
...
/* Button */
[data-testid="stButton"]>button{background:linear-gradient(135deg,#c9a96e,#8b6914)!important;color:#080b10!important;border:none!important;border-radius:2px!important;font-family:'DM Mono',monospace!important;font-size:.7rem!important;letter-spacing:.2em!important;text-transform:uppercase!important;padding:.6rem 1.4rem!important;width:100%!important;transition:opacity .2s ease!important;}
[data-testid="stButton"]>button:hover{opacity:.82!important;}
[data-testid="stDataFrame"]{border:1px solid #1a2235!important;border-radius:2px;}
[data-testid="stAlert"]{border-radius:2px!important;border-left-width:3px!important;font-size:.8rem!important;}
[data-testid="stWidgetLabel"]{font-size:.6rem!important;letter-spacing:.18em!important;text-transform:uppercase!important;color:#5a6478!important;}
.js-plotly-plot{border:1px solid #1a2235;border-radius:2px;}
hr{border-color:#1a2235!important;margin:2rem 0;}

/* Top strip */
.top-strip{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid #1a2235;border-radius:4px;overflow:hidden;margin-bottom:2rem;}
.strip-item{padding:1.1rem 1.4rem;border-right:1px solid #1a2235;}
.strip-item:last-child{border-right:none;}
.strip-label{font-size:.6rem;letter-spacing:.18em;text-transform:uppercase;color:#5a6478;margin-bottom:.3rem;}
.strip-value{font-family:'Cormorant Garamond',serif;font-size:1.9rem;font-weight:300;color:#e8dcc8;line-height:1;}
.strip-value.hi{color:#c9a96e;}
.strip-sub{font-size:.68rem;color:#5a6478;margin-top:.25rem;}

/* Panel */
.panel{background:#0c1118;border:1px solid #1a2235;border-radius:4px;padding:1.4rem 1.6rem;margin-bottom:1rem;}
.panel-title{font-size:.6rem;letter-spacing:.22em;text-transform:uppercase;color:#5a6478;margin-bottom:1.2rem;}

/* Progress */
.prog-wrap{margin-bottom:1.1rem;}
.prog-label{display:flex;justify-content:space-between;font-size:.72rem;color:#8a9ab0;margin-bottom:.35rem;}
.prog-label span{color:#e8dcc8;}
.prog-track{background:#1a2235;border-radius:2px;height:10px;overflow:hidden;}
.prog-fill{height:100%;border-radius:2px;display:flex;align-items:center;padding-left:.5rem;font-size:.6rem;color:#080b10;letter-spacing:.08em;}

/* Intel cards */
.intel-card{background:#0c1118;border:1px solid #1a2235;border-radius:4px;padding:1rem 1.2rem;margin-bottom:.7rem;}
.intel-card.good{border-left:3px solid #2ecc71;}
.intel-card.warn{border-left:3px solid #f39c12;}
.intel-card.bad{border-left:3px solid #e74c3c;}
.intel-card.info{border-left:3px solid #3b82f6;}
.intel-title{font-size:.82rem;color:#e8dcc8;margin-bottom:.3rem;}
.intel-body{font-size:.75rem;color:#8a9ab0;line-height:1.65;}

/* Scenario cards */
.sc-card{background:#0c1118;border:1px solid #1a2235;border-radius:4px;padding:1.1rem 1.3rem;margin-bottom:.7rem;}
.sc-badge{display:inline-block;font-size:.6rem;letter-spacing:.14em;text-transform:uppercase;padding:.2rem .7rem;border-radius:20px;margin-bottom:.55rem;}
...
.sc-title{font-size:.88rem;color:#e8dcc8;margin-bottom:.35rem;}
.sc-body{font-size:.75rem;color:#8a9ab0;line-height:1.65;}

/* Stat grid */
.stat-grid{display:grid;grid-template-columns:1fr 1fr;}
.stat-item{display:flex;justify-content:space-between;padding:.6rem 1.4rem;border-bottom:1px solid #1a2235;font-size:.74rem;}
.sk{color:#5a6478;}
.sv{color:#e8dcc8;}
...
def get_conn():
    return pyodbc.connect(
        ...
        "UID=loanuser;PWD=StrongPassword123!;"
    )
...
<div class="panel">
  ...
  <div style="font-size:.76rem;color:{pace_color};margin-top:.5rem;">
...
<div class="panel">
  ...
  <div style="font-size:.75rem;color:#8a9ab0;margin-top:.4rem;">
...
with st.sidebar:
    ...
    if submit:
        ...
        st.markdown(f"""
        <div style='margin-top:1rem;padding:1rem;background:#0c1118;border:1px solid #1a2235;border-radius:2px;font-size:.75rem;line-height:2;'>
    ...
    <div style='font-size:.75rem;line-height:2.4;color:#5a6478;'>
